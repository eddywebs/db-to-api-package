...
class DB_API {
	...
	function get_first_column( $table, $db = null ) {
		...
		$tmp = $this->get_columns( $table, $db ); //asigning to a temp variable before returning else getting message at https://stackoverflow.com/questions/4636166/only-variables-should-be-passed-by-reference
		return reset( $tmp );
